...
public class PostAndUserPartAdapter extends RecyclerView.Adapter<com.gpfei.graduationproject.adapters.PostAndUserPartAdapter.MyViewHolder> {
    private List<PostAndUserPart> datalist = new ArrayList<>();
    ...
    public PostAndUserPartAdapter(Context context, List<PostAndUserPart> datalist, String string) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        PostAndUserPartAdapter.MyViewHolder holder = new PostAndUserPartAdapter.MyViewHolder(view);
        return holder;
    }
