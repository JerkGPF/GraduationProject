    ...
    private void loadFull() {
        ...
        bmobQuery.getObject(objectId, new QueryListener<DayBean>() {
            ...
            public void done(DayBean object,BmobException e) {
                if(e==null){
                    et_hr_company_job.setText(object.getTitle_day());
                    et_hr_company_salary.setText(object.getMoney_day());
                    et_hr_company_name.setText(object.getCompany_day());
                    et_hr_company_place.setText(object.getAddress_day());
                    et_hr_company_url.setText(object.getUrl());
                }else{
                    Toast.makeText(ModifyActivity.this, "查询失败"+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
